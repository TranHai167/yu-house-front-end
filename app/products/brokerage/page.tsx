  ...
  return (
    <div className="container mx-auto px-4 py-16">
      <div className="mb-12 text-center">
        <h1 className="text-4xl font-bold text-yuhouse-navy">Property Listings</h1>
        <p className="mt-4 text-lg text-gray-600">Find your perfect home from our extensive property listings</p>
      </div>

      {/* Search and Filter */}
      <div className="mb-12 rounded-lg border bg-white p-6 shadow-md">
        <h2 className="mb-6 text-xl font-bold text-yuhouse-navy">Search Properties</h2>
